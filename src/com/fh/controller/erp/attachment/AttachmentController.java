package com.fh.controller.erp.attachment;
...
public class AttachmentController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		page.setPd(pd);
		List<PageData>	varList = attachmentService.list(page);	//列出Remarks列表
		mv.setViewName("erp/attachment/attachment_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("erp/attachment/attachment_edit");
